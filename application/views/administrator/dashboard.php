	...
	<div class="row">
		...
		<div class="col-xl-6 col-md-6">
			<div class="card bg-success text-white mb-4">
				<div class="card-body">
					<h4><span class="fas fa-user-check mr-2"></span>Sudah Dijemput</h4>
			...
			<div class="card-body">
				<div class="row detail">
					<div class="col-md-2 col-sm-4 col-6 p-2">
						...
						<p class="text-center">Foto Orang Tua</p>
					</div>
					...
					<div class="col-md-2">
						<img class="img-thumbnail" src="<?php echo base_url() ?>assets/img/uploads/<?php echo $data->foto_siswa ?> ?>" class="card-img" style="width:100%;">
						<p class="text-center">Foto Anak</p>
					</div>
				</div>
			</div>
			<div class="card-footer">
				<div class="d-flex align-items-center justify-content-between small">
					<div class="text-muted">NIS: <?php echo ucfirst($data->nis) ?></div>
					<div class="text-muted">Status: <?php if ($level=="ortu"){ echo 'Orang Tua Siswa'; } ?></div>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body item-center">
					...
					<div class="modal-footer">
						<a href="<?php echo base_url('OrangTua/UpdateQr/'.$data->id)?>"><button type="button" class="btn btn-sm btn-primary"><i class="fas fa-sync-alt"></i> Update QR Penjemputan</button></a>
